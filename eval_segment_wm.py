...
# swept on eval set), ap, plus per-class precision/recall/f1 - same metrics as train_mistake_detection.py.
...
def run_eval(model, loader, device, use_bf16: bool) -> dict:
    ...
    for thr in thresholds:
        ...
        _, _, f1_arr, sup_arr = precision_recall_fscore_support(
