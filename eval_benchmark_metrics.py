...
# for sanity - ours score ~50% macro-f1, not ~28% like holoassist table 7, so treat any
# comparison to that table as indicative only (their number is likely on a val split, not held-out test).
...
""")
    ...
    print(classification_report(labels, preds_05,
                                target_names=["correct", "mistake"],
