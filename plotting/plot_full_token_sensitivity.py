"""
Builds a figure from augmentation_sensitivity_full_tokens.json.

Plots full/centre/edge per-token cosine similarity for the slight_crop,
warm_tint, and combined augmentations.

Usage:
    python plot_full_token_sensitivity.py --results results/augmentation_sensitivity_full_tokens.json \
