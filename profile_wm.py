# profiles SegmentMaskPredictorAC forward+backward with torch.profiler: a few warmup steps,
# then prints the top ops/modules by self cuda time and writes a chrome trace
# (open at chrome://tracing for the timeline view).
# usage: python profile_wm.py --train_index ... --train_split ... --max_context_segs 4 --depth 24 --act_ckpt
